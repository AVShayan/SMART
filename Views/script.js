...
async function getUserDet(){
    ...
    const res = await fetch("https://bright-parks-ring.loca.lt/user",{
        method:"GET",
...
async function renderLights(){
    try{
        ...
        const res = await fetch('https://bright-parks-ring.loca.lt/light',{
            method:"GET",
            headers:{"Content-Type":"application/json"}
        });
...
async function sendSignal(clr,cmd){
    ...
    const res = await fetch('https://bright-parks-ring.loca.lt/signal',{
        method:"POST",
        headers:{"Content-Type":"application/json"},
        body: SIGNAL
    });
...
logout.addEventListener("click",async(e)=>{
    try{
        const res = await fetch("https://bright-parks-ring.loca.lt/logout",{
        method:"POST"
        });
    if(res.ok)
        window.location.href="./login.html";
