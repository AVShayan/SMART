...
async function getUserDet(){
    ...
    const res = await fetch("https://parents-speaking-plate-partner.trycloudflare.com/user",{
        method:"GET",
...
async function renderLights(){
    try{
        ...
        const res = await fetch('https://parents-speaking-plate-partner.trycloudflare.com/light',{
            method:"GET",
            headers:{"Content-Type":"application/json"},
            credentials:"include"
        });
...
async function sendSignal(clr,cmd){
    ...
    const res = await fetch('https://parents-speaking-plate-partner.trycloudflare.com/signal',{
        method:"POST",
        headers:{"Content-Type":"application/json"},
        body: SIGNAL,
        credentials:"include"
...
logout.addEventListener("click",async(e)=>{
    try{
        const res = await fetch("https://parents-speaking-plate-partner.trycloudflare/logout",{
        method:"POST",
        credentials:"include"
        });
    if(res.ok)
